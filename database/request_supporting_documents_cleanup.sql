...
-- from certificate-specific supporting documents. Run this if an earlier proof SQL
-- added identity/residency proofs or inferred hard uploads from broad purpose text.
...
-- and broad purpose wording is not enough to require an online upload.
