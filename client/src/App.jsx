...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/walkin-issuance" element={<AdminPage Component={WalkInIssuance} />} />
      <Route path="/admin/manage-requests" element={<AdminPage Component={ManageRequests} />} />
      <Route path="/admin/resident-records" element={<AdminPage Component={ResidentRecords} />} />
      <Route path="/admin/reports" element={<AdminPage Component={Reports} />} />
      <Route path="/admin/logs-audit-trail" element={<AdminPage Component={LogsAuditTrail} />} />
      <Route path="/admin/manage-accounts" element={<AdminPage Component={ManageAccounts} />} />
      <Route path="/admin/settings" element={<AdminPage Component={Settings} />} />

      <Route path="/resident/login" element={<ResidentLoginRoute />} />
      <Route path="/resident/register" element={<ResidentRegisterRoute />} />
      ...
      <Route path="/signup" element={<Navigate to="/resident/register" replace />} />
      <Route path="/resident/signup" element={<Navigate to="/resident/register" replace />} />
