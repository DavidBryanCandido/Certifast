...
export default function MyRequests({ resident, onLogout }) {
    ...
    return (
        <div className="rh-root" style={{ display: "flex", minHeight: "100vh" }}>
            {/* ── DESKTOP SIDEBAR ── */}
            {!isMobile && (
                <ResidentSidebar active="history" resident={resident} onLogout={onLogout} />
            )}
            ...
            {/* ── CONTENT ── */}
            <div style={{ width: "100%", boxSizing: "border-box", padding: isMobile ? "20px 16px 80px" : "28px 24px 40px" }}>
