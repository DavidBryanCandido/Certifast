...
import {
    ...
    ScrollText, UserCog, Settings, LogOut, Search,
    ChevronLeft, ChevronRight, X, Check, QrCode,
    Printer, Eye, Menu,
} from "lucide-react";
...
// =============================================================
const MOCK_REQUESTS = [
    { id: "#REQ-0148", name: "Juan dela Cruz",    certType: "Barangay Clearance",       purpose: "Employment",         date: "Mar 11, 2026", time: "10:24 AM", status: "pending",  hasFee: true,  address: "123 Rizal St., East Tapinac", contact: "+63 912 345 6789", email: "juan@email.com", civil: "Single", nationality: "Filipino" },
    { id: "#REQ-0147", name: "Lorna Reyes",       certType: "Business Permit",          purpose: "Business Registration",date: "Mar 11, 2026", time: "9:58 AM",  status: "pending",  hasFee: true,  address: "45 Mabini St., East Tapinac", contact: "+63 917 654 3210", email: "lorna@email.com", civil: "Married", nationality: "Filipino" },
    { id: "#REQ-0146", name: "Maria Santos",      certType: "Certificate of Residency", purpose: "Bank Requirements",  date: "Mar 10, 2026", time: "2:15 PM",  status: "approved", hasFee: false, address: "78 Del Pilar St., East Tapinac", contact: "+63 905 111 2222", email: "maria@email.com", civil: "Married", nationality: "Filipino" },
    { id: "#REQ-0145", name: "Ricardo Mendoza",   certType: "Certificate of Indigency", purpose: "Medical Assistance", date: "Mar 10, 2026", time: "11:00 AM", status: "ready",    hasFee: false, address: "12 Luna St., East Tapinac", contact: "+63 918 987 6543", email: "ricardo@email.com", civil: "Single", nationality: "Filipino" },
    { id: "#REQ-0144", name: "Felicidad Torres",  certType: "Barangay Clearance",       purpose: "Employment",         date: "Mar 9, 2026",  time: "3:40 PM",  status: "ready",    hasFee: true,  address: "56 Rizal St., East Tapinac", contact: "+63 912 000 1111", email: "felicidad@email.com", civil: "Single", nationality: "Filipino" },
    { id: "#REQ-0143", name: "Eduardo Bautista",  certType: "Barangay Clearance",       purpose: "Travel Abroad",      date: "Mar 9, 2026",  time: "9:10 AM",  status: "released", hasFee: true,  address: "90 Aguinaldo St., East Tapinac", contact: "+63 910 222 3333", email: "eduardo@email.com", civil: "Married", nationality: "Filipino" },
    { id: "#REQ-0142", name: "Natividad Garcia",  certType: "Certificate of Indigency", purpose: "Financial Aid",      date: "Mar 8, 2026",  time: "4:55 PM",  status: "rejected", hasFee: false, address: "34 Mabini St., East Tapinac", contact: "+63 916 444 5555", email: "naty@email.com", civil: "Widowed", nationality: "Filipino" },
    { id: "#REQ-0141", name: "Crisanto Villanueva",certType: "Barangay Clearance",      purpose: "Employment",         date: "Mar 8, 2026",  time: "10:30 AM", status: "released", hasFee: true,  address: "67 Del Pilar St., East Tapinac", contact: "+63 919 666 7777", email: "crisanto@email.com", civil: "Single", nationality: "Filipino" },
];
...
const TIMELINE_MAP = {
    pending:  [{ dot: "gold", text: "Request submitted by resident", time: "Mar 11, 2026 · 10:24 AM" }, { dot: "grey", text: "Awaiting staff review", time: "Pending" }],
    approved: [{ dot: "gold", text: "Request submitted by resident", time: "Mar 11, 2026 · 9:00 AM" }, { dot: "blue", text: "Approved by Staff Reyes", time: "Mar 11, 2026 · 9:50 AM" }, { dot: "grey", text: "Awaiting print & signing", time: "Pending" }],
    ready:    [{ dot: "gold", text: "Request submitted by resident", time: "Mar 10, 2026 · 11:00 AM" }, { dot: "blue", text: "Approved by Staff Cruz", time: "Mar 10, 2026 · 11:45 AM" }, { dot: "blue", text: "Certificate printed", time: "Mar 10, 2026 · 11:50 AM" }, { dot: "green", text: "Marked Ready for Pickup", time: "Mar 10, 2026 · 2:00 PM" }, { dot: "grey", text: "Awaiting resident pickup", time: "Pending" }],
    released: [{ dot: "gold", text: "Request submitted by resident", time: "Mar 9, 2026 · 9:00 AM" }, { dot: "blue", text: "Approved by Staff Reyes", time: "Mar 9, 2026 · 9:30 AM" }, { dot: "blue", text: "Certificate printed", time: "Mar 9, 2026 · 9:35 AM" }, { dot: "green", text: "Marked Ready for Pickup", time: "Mar 9, 2026 · 9:40 AM" }, { dot: "green", text: "Released · QR scanned by Staff Reyes", time: "Mar 9, 2026 · 3:15 PM" }],
    rejected: [{ dot: "gold", text: "Request submitted by resident", time: "Mar 8, 2026 · 4:55 PM" }, { dot: "red", text: "Rejected by Staff Cruz — Incomplete documents", time: "Mar 8, 2026 · 5:10 PM" }],
};
...
function formatDateShort() { return new Date().toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }); }
function formatDate() { return new Date().toLocaleDateString("en-US", { weekday: "long", year: "numeric", month: "long", day: "numeric" }); }
...
function Sidebar({ admin, activePage, onNavigate, onLogout, collapsed }) {
    ...
    const NavBtn = ({ item }) => collapsed ? (
        <button className={`mr-nav-item-icon${activePage === item.key ? " active" : ""}`} onClick={() => onNavigate(item.key)} title={item.label}>
            <item.Icon size={18} opacity={0.7} />
        </button>
    ) : (
        <button className={`mr-nav-item${activePage === item.key ? " active" : ""}`} onClick={() => onNavigate(item.key)}>
            <item.Icon size={15} opacity={0.7} />{item.label}
        ...
        <aside style={{ ...sd.sidebar, width: collapsed ? 60 : 240 }}>
            ...
            {isSA && (
                <div style={sd.superAdminSection}>
                    ...
                    {sa.map(item => <NavBtn key={item.key} item={item} />)}
                </div>
            )}
            <div style={{ ...sd.userRow, justifyContent: collapsed ? "center" : "flex-start", padding: collapsed ? "14px 0" : "14px 20px" }}>
                ...
                {!collapsed && (
                    <>
                        <div style={sd.userInfo}><div style={sd.userName}>{admin?.name || "Dante Administrador"}</div><div style={sd.userRole}>{admin?.role || "Superadmin"}</div></div>
                        <button className="mr-logout-btn" onClick={onLogout}><LogOut size={14} /></button>
                    </>
                )}
            </div>
        </aside>
    ...
    return (
        <div style={{ position: "fixed", inset: 0, zIndex: 200, display: "flex" }}>
            ...
            <aside style={{ ...sd.sidebar, width: 260, position: "relative", animation: "sidebarSlideIn 0.22s ease both", zIndex: 1 }}>
                ...
                {nav.map(item => (
                    <button key={item.key} className={`mr-nav-item${activePage === item.key ? " active" : ""}`} onClick={() => { onNavigate(item.key); onClose(); }}>
                        <item.Icon size={15} opacity={0.7} />{item.label}
                        {item.badge && <span style={sd.navBadge}>{item.badge}</span>}
                    </button>
                ))}
...
function RequestDrawer({ request, onClose, isMobile, onActionComplete }) {
    ...
    const SectionTitle = ({ children }) => <div className="mr-section-title">{children}</div>;

    const renderFooter = () => {
        if (step === "reject") return (
            <>
                <button className="mr-drawer-btn" style={{ background: "#f8f6f1", color: "#4a4a6a", border: "1px solid #e4dfd4" }} onClick={() => setStep("default")}>Cancel</button>
                {/* TODO: POST /api/requests/:id/reject with rejectReason */}
                <button className="mr-drawer-btn" style={{ flex: 2, background: "#b02020", color: "#fff" }} onClick={() => { onActionComplete("rejected", request.id); onClose(); }}>
        ...
        if (step === "release") return (
            <>
                ...
                <button className="mr-drawer-btn" style={{ flex: 2, background: "#1a7a4a", color: "#fff" }} onClick={() => { onActionComplete("released", request.id); onClose(); }}>
        ...
        if (request.status === "pending") return (
            <>
                <button className="mr-drawer-btn" style={{ background: "#fdecea", color: "#b02020", border: "1px solid #f5c0c0" }} onClick={() => setStep("reject")}><X size={11} /> Reject</button>
                {/* TODO: POST /api/requests/:id/approve */}
                <button className="mr-drawer-btn" style={{ flex: 2, background: "#1a7a4a", color: "#fff" }} onClick={() => { onActionComplete("approved", request.id); onClose(); }}>
        ...
        if (request.status === "approved") return (
            <>
                ...
                <button className="mr-drawer-btn" style={{ background: "#1a4a8a", color: "#fff" }}><Printer size={13} /> Print Certificate</button>
                <button className="mr-drawer-btn" style={{ background: "#d4edda", color: "#8aaa8a", cursor: "not-allowed" }} disabled title="Print first">Mark Ready</button>
            </>
        );
        if (request.status === "ready") return (
            <>
                <button className="mr-drawer-btn" style={{ background: "#e8eef8", color: "#1a4a8a", border: "1px solid #b8cce8" }}><Printer size={13} /> Reprint</button>
                <button className="mr-drawer-btn" style={{ flex: 2, background: "#e8f5ee", color: "#1a7a4a", border: "1px solid #a8d8bc" }} onClick={() => setStep("release")}>
                    <QrCode size={13} /> Scan QR &amp; Release
                </button>
            </>
        );
        if (request.status === "released") return (
            <button className="mr-drawer-btn" style={{ background: "#e8eef8", color: "#1a4a8a", border: "1px solid #b8cce8" }}><Printer size={13} /> Reprint Certificate</button>
        );
        if (request.status === "rejected") return (
            <div style={{ fontSize: 11.5, color: "#9090aa", textAlign: "center", width: "100%", padding: "4px 0" }}>This request has been rejected. No further action available.</div>
        );
        return null;
    };
        ...
        <div style={overlayStyle} onClick={(e) => e.target === e.currentTarget && onClose()}>
            <div className={isMobile ? "mr-drawer-mobile" : "mr-drawer"}>
                ...
                <div style={{ padding: "20px 24px", borderBottom: "1px solid rgba(255,255,255,0.1)", display: "flex", alignItems: "flex-start", justifyContent: "space-between", background: "linear-gradient(135deg,#0e2554,#163066)", flexShrink: 0 }}>
                    <div>
                        <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 16, color: "#fff", margin: 0 }}>Request {request.id}</h3>
                        <p style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", marginTop: 3 }}>{request.certType} · Filed {request.date}</p>
                    </div>
                ...
                <div className="mr-drawer-body">
                    ...
                    {request.status === "rejected" && (
                        <div className="mr-drawer-section">
                            ...
                            <div style={{ background: "#f8f6f1", border: "1px solid #e4dfd4", borderRadius: 4, padding: "10px 12px", fontSize: 12, color: "#4a4a6a", lineHeight: 1.6 }}>
                                Incomplete supporting documents submitted. Resident must re-submit with a valid government-issued ID and proof of residency.
                            </div>
                        </div>
                    )}
                    ...
                    {step === "reject" && (
                        <div className="mr-drawer-section">
                            ...
                            <textarea className="mr-reject-textarea" placeholder="Enter reason for rejection — this will be visible to the resident…"
...
export default function ManageRequests({ admin, onLogout, onNavigate: navProp }) {
    ...
    return (
        <div className="mr-root">
            ...
            {!isMobile && (
                <Sidebar admin={admin || { name: "Dante Administrador", role: "superadmin" }} activePage={activePage} onNavigate={handleNavigate} onLogout={handleLogout} collapsed={isTablet} />
            )}

            {showMobileSidebar && (
                <MobileSidebar admin={admin || { name: "Dante Administrador", role: "superadmin" }} activePage={activePage} onNavigate={handleNavigate} onClose={() => setShowMobileSidebar(false)} onLogout={handleLogout} />
            )}

            {selectedRequest && (
                <RequestDrawer request={selectedRequest} onClose={() => setSelectedRequest(null)} isMobile={isMobile} onActionComplete={handleActionComplete} />
            )}
            ...
            <div style={{ marginLeft: sidebarWidth, flex: 1, display: "flex", flexDirection: "column", minHeight: "100vh" }}>
                ...
                <div style={{ padding: isMobile ? "16px 16px 24px" : "28px 32px", flex: 1 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 22, flexWrap: "wrap", gap: 12 }}>
                        <div>
                            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: isMobile ? 18 : 20, color: "#0e2554" }}>All Requests</h2>
...
const td = { padding: "12px 16px", fontSize: 12.5, borderBottom: "1px solid #f5f0ea", verticalAlign: "middle", transition: "background 0.1s" };
