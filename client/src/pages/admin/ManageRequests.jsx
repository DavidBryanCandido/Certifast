...
function RequestDrawer({
    ...
    const handleMarkReady = async () => {
        ...
        const buildCertificateTemplateHtml = (signatorySnapshot, issue = {}) => {
            ...
            const issuedAt =
                issue?.issuedAt || issue?.issuedDate || issueExtraFields.dateIssued || new Date();
            ...
            const printSignatories =
                issue?.signatorySnapshot || signatorySnapshot;
            return (
                buildCertificatePrintHtml({
        ...
        const openCertificatePrintWindow = (
                ...
                win.document.open();
                win.document.write(
                    buildCertificateTemplateHtml(signatorySnapshot, issue),
                );
                win.document.close();
                win.focus();
