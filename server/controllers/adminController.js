...
async function getResidents(req, res) {
    ...
    const residentColumns = `
        ...
        to_jsonb(res)->>'residency_proof_url' AS residency_proof_url,
        to_jsonb(res)->>'residency_proof_file_name' AS residency_proof_file_name,
        to_jsonb(res)->>'residency_proof_mime_type' AS residency_proof_mime_type,
        to_jsonb(res)->>'residency_proof_file_size' AS residency_proof_file_size,
